...
/*
{
  "ProductKey": "k0f5uloSgY3",
  "DeviceName": "STM32",
  "DeviceSecret": "4289d177b95c1b0458914632ea1e1099"
  {
  "ProductKey": "k0f5uloSgY3",
  "DeviceName": "STM32",
  "DeviceSecret": "4289d177b95c1b0458914632ea1e1099"
...
#define  PRODUCTKEY           "k0f5uloSgY3"                                        //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                                   //产品ID长度
#define  DEVICENAME           "STM32"                                               //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                                   //设备名长度
#define  DEVICESECRE          "4289d177b95c1b0458914632ea1e1099"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度
#define  S_TOPIC_NAME         "/k0f5uloSgY3/STM32/user/get"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/k0f5uloSgY3/STM32/user/update"    //需要发布的主题     
