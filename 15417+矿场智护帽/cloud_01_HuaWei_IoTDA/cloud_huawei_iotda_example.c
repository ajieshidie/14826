...
// 设备密码 fs12345678
// 设备ID
#define DEVICE_ID "6652f61d7dbfd46fabbd77a0_hi861"
// MQTT客户端ID
#define MQTT_CLIENT_ID "6652f61d7dbfd46fabbd77a0_hi861_0_0_2024052612"
// MQTT用户名
#define MQTT_USER_NAME "6652f61d7dbfd46fabbd77a0_hi861"
// MQTT密码
#define MQTT_PASS_WORD "f9917d9f5d6f9448539c937182067b3f834328452ad879d0b821cf9ab09011c6"
// 华为云平台的IP地址
...
#define MsgQueueObjectNumber 32 // 定义消息队列对象的个数
...
int Packaged_json_data(void)
{
    ...
    cJSON_AddNumberToObject(properties, "illumination", sensorData.light);
    ...
    cJSON_AddNumberToObject(properties, "Air", int(137));
    cJSON_AddNumberToObject(properties, "Gas", int(151));
    cJSON_AddNumberToObject(properties, "illumination", int(47));
    cJSON_AddNumberToObject(properties, "BodyTemperature", int(35)));
    cJSON_AddNumberToObject(properties, "Pressure", int(66)));
    /*
    cJSON_AddNumberToObject(properties, "air", int());
    cJSON_AddNumberToObject(properties, "gas", int());
    cJSON_AddNumberToObject(properties, "lsens", int());
    cJSON_AddNumberToObject(properties, "body_temperature", int());
    */
    /*
        uint16_t gas;  
    uint16_t lsens; 
...
static void network_wifi_mqtt_example(void)
{
    ...
    // 连接WiFi
    if (WiFi_connectHotspots("Crush", "12345678") != WIFI_SUCCESS) {
